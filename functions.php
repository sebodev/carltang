...
function forward_scripts() {
	...
	if ( !is_admin() ) {
	  ...
	  wp_enqueue_script( 'forward-js-core', get_template_directory_uri() . '/assets/js/core' . $suffix . '.js', array( 'jquery' ), filemtime( get_template_directory() . '/js/core' . $suffix . '.js' ), true );
...
/**
 * Change the acf uri
 * @param  string $path Update the acf uri.
...
/**
 * Change the acf dir
 * @param  string $dir Update the acf dir.
 * @return string      new dir
 */
